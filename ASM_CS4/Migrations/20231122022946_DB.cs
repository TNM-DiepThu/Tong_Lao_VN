        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlImage = table.Column<string>(type: "nvarchar(100)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_bill_Details_HoaDon_IDHD",
                        column: x => x.IDHD,
                        principalTable: "HoaDon",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bill_Details_products_IDSP",
                        column: x => x.IDSP,
                        principalTable: "products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bill_Details_IDHD",
                table: "bill_Details",
                column: "IDHD");

            migrationBuilder.CreateIndex(
                name: "IX_bill_Details_IDSP",
                table: "bill_Details",
                column: "IDSP");

            migrationBuilder.CreateIndex(
                name: "IX_Cart_Details_IdSp",
                table: "Cart_Details",
                column: "IdSp");
